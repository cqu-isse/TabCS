...
class CodeSearcher:
    ...
    def train(self, model):
        ...
        f1=open('/data/shuaijianhang/TSACS-TASF/keras/results/training_results.txt','a',encoding='utf-8',errors='ignore')
    ...
    def eval(self, model, K):
        ...
        if self._eval_sets is None:
            ...
            self._eval_sets['descs']=descs
        data_len=len(self._eval_sets['descs'])
        numbers = codecs.open('/data/shuaijianhang/Vocab3Hybrid-CARLCS_Hiera_Attention/keras/results/bootstrap_nums.txt','a',errors = 'ignore', encoding = 'utf-8')
        for k in range(0,10):
            ...
            f2=codecs.open('/data/shuaijianhang/Vocab3Hybrid-CARLCS_Hiera_Attention/keras/results/bootsrtap_results.txt','a',encoding='utf-8',errors='ignore')
