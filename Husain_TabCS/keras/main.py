...
class CodeSearcher:
    ...
    def train(self, model):
        ...
        f1=open('/data/shuaijianhang/codeSearchNet_MACS_TASF/keras/results/training_results.txt','a',encoding='utf-8',errors='ignore')
    ...
    def eval(self, model, K):
        ...
        for i in range(30,100):
            ...
            print(self.revert(self.vocab_desc, desc))
        ...
        f2=open('/data/shuaijianhang/codeSearchNet_MACS_TASF/keras/results/eval_results.txt','a',encoding='utf-8',errors='ignore')
        f2.write('SuccRate1={},SuccRate5={},SuccRate10={}, ACC={}, MRR={}, MAP={}, nDCG={}'.format(succrate1,succrate5,succrate10,acc,mrr,map,ndcg))
        return succrate10,acc,mrr,map,ndcg
    ...
    def repr_code(self,model):
        ...
        sbt = self.pad(sbt, self.data_params['sbt_len'])
        vecs = model.repr_code([methnames, apiseqs, tokens,sbt], batch_size=1000)
    ...
    def search(self,model,query,n_results=10):
        ...
        sims = model.predict([padded_methnames,padded_apiseqs,padded_tokens,padded_sbt,padded_desc],batch_size=1000).flatten()
...
if __name__ == '__main__':
    K.set_session(get_session(0.4))  # using 80% of total GPU Memory
    args = parse_args()
