...
class JointEmbeddingModel:
    ...
    def build(self):
        ...
        dropout = Dropout(0.25,name='dropout_methname_atten')
        methname_out = dropout(methname_out)
        ...
        dropout = Dropout(0.25, name = 'dropout_apiseq_atten')
        api_out = dropout(api_out)
        ...
        dropout = Dropout(0.25, name = 'dropout_tokens_atten')
        tokens_out = dropout(tokens_out)
        ...
        dropout = Dropout(0.25,name='dropout_sbt_atten')
        sbt_out= dropout(sbt_out)
        ...
        dropout = Dropout(0.25,name='dropout_desc_atten')
        merged_desc = dropout(merged_desc)
